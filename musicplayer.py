...
def add_song():
	...
	song = song.replace("C:/Users/Girid/OneDrive/Desktop/url shortner/audio/", "")
...
# Create Playlist Box
song_box = Listbox(master_frame, bg="black", fg="green", width=60,height=10, selectbackground="green", selectforeground="black")
song_box.grid(row=0, column=0)

# Define Player Control Button Images
back_btn_img = PhotoImage(file='left.png')
forward_btn_img =  PhotoImage(file='right.png')
...
my_slider.grid(row=2, column=0, pady=5)
